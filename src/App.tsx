...
import ModuleAssignmentScreen from './screens/ModuleAssignmentScreen';
...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/course/:courseId/module/:moduleId/quiz"                            element={<ProtectedPage><ModuleQuizScreen /></ProtectedPage>} />
      <Route path="/course/:courseId/module/:moduleId/assignment"                      element={<ProtectedPage><ModuleAssignmentScreen /></ProtectedPage>} />
